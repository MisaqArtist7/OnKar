...
${t.join(`
`)}
`),this.reset()}[Symbol.dispose](){le&&this.report()}};function ne(e){return`\x1B[2m${e}\x1B[22m`}function ct(e){return`\x1B[34m${e}\x1B[39m`}import Vr from"@ampproject/remapping";import{Features as J,transform as Tr}from"lightningcss";import Er from"magic-string";function _a(e,{file:r="input.css",minify:t=!1,map:i}={}){function o(a,u){return Tr({filename:r,code:a,minify:t,sourceMap:typeof u<"u",inputSourceMap:u,drafts:{customMedia:!0},nonStandard:{deepSelectorCombinator:!0},include:J.Nesting|J.MediaQueries,exclude:J.LogicalProperties|J.DirSelector|J.LightDark,targets:{safari:16<<16|1024,ios_saf:16<<16|1024,firefox:8388608,chrome:7274496},errorRecovery:!0})}let l=o(Buffer.from(e),i);i=l.map?.toString(),l=o(l.code,i),i=l.map?.toString();let n=l.code.toString(),s=new Er(n);if(s.replaceAll("@media not (","@media not all and ("),i!==void 0&&s.hasChanged()){let a=s.generateMap({source:"original",hires:"boundary"}).toString();i=Vr([a,i],()=>null).toString()}return n=s.toString(),{code:n,map:i}}import{SourceMapGenerator as Rr}from"source-map-js";function Pr(e){let r=new Rr,t=1,i=new h(o=>({url:o?.url??`<unknown ${t++}>`,content:o?.content??"<none>"}));for(let o of e.mappings){let l=i.get(o.originalPosition?.source??null);r.addMapping({generated:o.generatedPosition,original:o.originalPosition,source:l.url,name:o.name}),r.setSourceContent(l.url,l.content)}return r.toString()}function Fa(e){let r=typeof e=="string"?e:Pr(e);return{raw:r,get inline(){let t="";return t+="/*# sourceMappingURL=data:application/json;base64,",t+=Buffer.from(r,"utf-8").toString("base64"),t+=` */
`,t}}}if(!process.versions.bun){let e=oe.createRequire(import.meta.url);oe.register?.(Or(e.resolve("@tailwindcss/node/esm-cache-loader")))}export{ba as Features,ut as Instrumentation,xa as Polyfills,Na as __unstable__loadDesignSystem,Sa as compile,$a as compileAst,ae as env,at as loadModule,be as normalizePath,_a as optimize,Fa as toSourceMap};
